...
public class WeatherViewModel extends ViewModel {
    ...
    private MutableLiveData<ArrayList<Weather>> data;
    private String temperature;
    private String city;
    private String units;
    private ArrayList<Weather> weathersArray;

    public WeatherViewModel(Application application, String city,String units,ArrayList<Weather> weathersArray) {
    ...
    public LiveData<ArrayList<Weather>> getDataWeather() {
        if (data == null) {
